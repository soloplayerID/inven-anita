...
<?php $setting = \App\Models\Setting::find(1); ?>
    <title>Login - {{ $setting->name_application }}</title>
@endsection
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    ...
                    @else
                    <img style="width: 80px" alt="Taruna Bhakti Logo" class="w-10" src="{{ asset('/fotoSetting/'.$setting->logo) }}">
                    @endif
                    <span class="text-white text-lg ml-1">
                        {{ $setting->name_application }} <span class="font-medium"></span>
                    </span>
                </a>
                <div class="my-auto">
                    <img alt="Midone Tailwind HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="{{ asset('/fotoSetting/'.$setting->logo) }}">
                    {{--<div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Aplikasi Penjualan</div>--}}
                ...
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-8">
                        <form id="login-form">
                            ...
                            <input id="password" type="password" class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4" placeholder="Kata sandi" value="">
                    ...
                    <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                        <div class="flex items-center mr-auto">
                            ...
                            <label class="cursor-pointer select-none" for="remember-me">Ingat kata sandi</label>
                        </div>
