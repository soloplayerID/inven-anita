                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        ...
                        <div class="px-5 pb-8 text-center flex items-center justify-center">
                            ...
                            <form action="{{ route('supplier.destroy',$delete->id) }}" method="post">
                                @csrf
                                @method('DELETE')
...
<div id="edit-{{ $item->id }}" data-backdrop="static" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
            ...
            {{-- Form --}}
            <form enctype="multipart/form-data" action="{{ route('supplier.update',$item->id) }}" method="POST">
                @csrf
                @method('PUT')
                <!-- BEGIN: Modal Body -->
...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Data Supplier </h2>
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        ...
        <a href="javascript:;" class="tooltip btn btn-primary shadow-md mr-2" title="Add New Supplier" data-toggle="modal"
            data-target="#add">
                    ...
                    <tr class="hover:bg-gray-200">
                        ...
                        <td class="border">
                            <a href="javascript:;" class="tooltip btn btn-warning-soft shadow-md mr-2"
                                title="Edit supplier" data-toggle="modal" data-target="#edit-{{ $item->id }}">
                                <i class="w-4 h-4" data-feather="edit"></i>
                            </a>
                            <a href="javascript:;" class="tooltip btn btn-danger-soft shadow-md mr-2"
                                title="Delete supplier" data-toggle="modal" data-target="#delete-user-{{ $item->id }}">
