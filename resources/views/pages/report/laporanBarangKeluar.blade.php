...
<html lang="en">
  <head>
    ...
    <title>Laporan Barang Keluar {{ \Carbon\Carbon::parse($startDay)->setTimezone('Asia/Jakarta')->isoFormat('D MMMM YYYY ') }} - {{ \Carbon\Carbon::parse($endDay)->setTimezone('Asia/Jakarta')->isoFormat('D MMMM YYYY ') }}</title>
    <style>
      .margin-top {
				margin-top: 100px;
			}
